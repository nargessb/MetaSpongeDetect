...
class _Kettle():
    ...
    Most notably .poison_lookup is a dictionary that maps image ids to their slice in the poison_delfta tensor.
    ...
    def select_poisons(self, victim, selection):
        ...
        if selection == 'max_gradient':
            ...
            indices = [i[0] for i in sorted(enumerate(grad_norms), key=sort_by_second_element)][-poison_num:]
